            ...
            <div className="max-w-4xl mx-auto">
                ...
                {results.length > 0 ? (
                        ...
                        {results.map((res, index) => (
                            <div key={index} className="group">
                                <Link to={res.link} className="block">
                                    <h3 className="font-bold text-[#47622A] dark:text-[#799851] group-hover:underline mb-1">
                                        {res.title}
                                    </h3>
                                </Link>
                                <p className="text-green-800/60 dark:text-green-500/60 mb-2 font-mono">
                    ...
                    <div className="py-12 text-center">
                        <h5 className="text-gray-500 font-bold">No results found for "{query}".</h5>
                        <p className="text-gray-400">Validating simple mock functionality.</p>
                    </div>
                )}
            </div>
        </div>
