    ...
    return (
        <div className="pt-24 min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300 font-sans pb-24">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
                <p className="inline-block py-1 px-3 rounded-full bg-[#47622A]/10 text-[#47622A] font-bold tracking-wider uppercase mb-6">
                    Get In Touch
                </p>
                <h1 className="font-extrabold mb-8 tracking-tight">
                    Contact Us
                </h1>
                <h5 className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed font-light">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                    ...
                    <div className="space-y-12">
                        {/* Contact Details */}
                        <div>
                            <h2 className="font-bold mb-8 flex items-center gap-3">
                                Company Information
                            ...
                            <div className="space-y-8">
                                <div className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        <h3 className="font-bold uppercase tracking-wider mb-2">Headquarters</h3>
                                        <h6 className="text-gray-900 dark:text-white leading-relaxed font-medium">
                                ...
                                <div className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        ...
                                        <h6 className="text-gray-900 dark:text-white font-medium">
                                ...
                                <div className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        ...
                                        <h6 className="text-gray-900 dark:text-white font-medium">
                                            <a href="mailto:info@msasia.com" className="hover:text-[#47622A] transition-colors">
                                                info@msasia.com
                                            </a>
                                        </h6>
                                    </div>
                        ...
                        <div className="h-64 sm:h-80 bg-gray-200 dark:bg-gray-800 rounded-3xl overflow-hidden shadow-inner relative flex items-center justify-center group border-4 border-white dark:border-gray-800">
                            ...
                            <div className="relative z-10 text-center transform group-hover:scale-105 transition-transform duration-500">
                                ...
                                <p className="bg-white/90 dark:bg-gray-900/90 px-4 py-1.5 rounded-full font-bold text-gray-600 dark:text-gray-300 shadow-sm backdrop-blur-sm">
                                    Google Map Embed
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-8 md:p-12 border border-blue-50 dark:border-gray-800 sticky top-24">
                        <div className="mb-10">
                            <h2 className="font-bold mb-2">Send us a Message</h2>
                        ...
                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Name</label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-2">
                                    <label className="font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Phone</label>
                                    <input
                                        type="tel"
                            ...
                            <div className="space-y-2">
                                <label className="font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Email</label>
                                <input
                                    type="email"
                            ...
                            <div className="space-y-2">
                                <label className="font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Service Interest</label>
                            ...
                            <div className="space-y-2">
                                <label className="font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Message</label>
                                <textarea
                                    rows="5"
