...
function NotFound() {
    ...
    return (
        <div className="pt-24 min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-center text-center px-4 transition-colors duration-300 font-sans pb-20">
            <h1 className="] leading-none font-bold text-[#47622A]/5 select-none -mb-16">
                404
            </h1>
            <div className="relative z-10">
                ...
                <h6 className="text-gray-600 dark:text-gray-400 mb-10 max-w-lg mx-auto leading-relaxed">
