        ...
        <div className="pt-24 min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 font-sans pb-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 md:p-12">
                    <h1 className="font-bold mb-4 border-b pb-4 border-gray-100 dark:border-gray-700">Privacy Policy</h1>
                    ...
                    <div className="max-w-none">
                        ...
                        <h2 className="font-bold mt-10 mb-4">1. Information We Collect</h2>
                        ...
                        <h2 className="font-bold mt-10 mb-4">2. How We Use Your Information</h2>
                        ...
                        <h2 className="font-bold mt-10 mb-4">3. Data Security</h2>
                        <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                        ...
                        <h2 className="font-bold mt-10 mb-4">4. Contact Us</h2>
