    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 font-sans">
            ...
            <div className="py-24 text-center px-4">
                <h1 className="font-black mb-6">Standard of Excellence</h1>
                <div className="w-24 h-1.5 bg-[#799851] mx-auto rounded-full mb-8"></div>
                <h5 className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto px-4 pb-24">
                <div className="space-y-12">
                    <div className="flex gap-6">
                        <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#799851] text-white flex items-center justify-center font-bold">1</div>
                        <div>
                            <h3 className="font-bold mb-3">Unwavering Compliance</h3>
                            <h6 className="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div className="flex gap-6">
                        <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#799851] text-white flex items-center justify-center font-bold">2</div>
                        <div>
                            <h3 className="font-bold mb-3">Operational Precision</h3>
                            <h6 className="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div className="flex gap-6">
                        <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#799851] text-white flex items-center justify-center font-bold">3</div>
                        <div>
                            <h3 className="font-bold mb-3">Customer-Centricity</h3>
                            <h6 className="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div className="flex gap-6">
                        <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#799851] text-white flex items-center justify-center font-bold">4</div>
                        <div>
                            <h3 className="font-bold mb-3">Continuous Improvement</h3>
                            <h6 className="text-gray-600 dark:text-gray-400 leading-relaxed">
