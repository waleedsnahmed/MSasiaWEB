        ...
        <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 font-sans py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                    <h1 className="font-black mb-6">Case Studies</h1>
                        ...
                        <div key={idx} className="bg-gray-50 dark:bg-[#111] rounded-3xl overflow-hidden border border-gray-100 dark:border-gray-800 hover:border-[#799851] transition-all group">
                            <div className="grid grid-cols-1 lg:grid-cols-3">
                                <div className="bg-[#799851] p-8 text-white flex flex-col justify-center">
                                    ...
                                    <p className="opacity-90 font-semibold uppercase tracking-wider">{c.client}</p>
                                </div>
                                <div className="lg:col-span-2 p-8 lg:p-12">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                        <div>
                                            <h4 className="font-bold mb-2">Challenge</h4>
                                            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{c.challenge}</p>
                                        </div>
                                        <div>
                                            <h4 className="font-bold mb-2">Solution</h4>
                                            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{c.solution}</p>
                                        </div>
                                        <div>
                                            <h4 className="font-bold mb-2">Result</h4>
                                            <p className="font-semibold text-[#799851] leading-relaxed">{c.result}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
