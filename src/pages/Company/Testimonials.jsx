        ...
        <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 font-sans py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                    <h1 className="font-black mb-6">Client Success Stories</h1>
                    <h5 className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {testimonials.map((item, idx) => (
                        <div key={idx} className="bg-gray-50 dark:bg-[#111] p-10 rounded-3xl relative">
                            <span className="text-[#799851] opacity-20 font-serif absolute top-6 left-6" style={{ fontSize: '60px', lineHeight: '1' }}>"</span>
                            <h6 className="text-gray-700 dark:text-gray-300 mb-8 relative z-10 italic leading-relaxed">
                                {item.quote}
                            </h6>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#799851]">{item.role}, {item.company}</p>
                                </div>
                            </div>
                        </div>
                    ))}
                ...
                <div className="mt-24 pt-10 border-t border-gray-100 dark:border-gray-800">
                    <p className="text-center text-gray-400 mb-8 uppercase tracking-widest font-bold">Trusted By Industry Leaders</p>
                    <div className="flex flex-wrap justify-center gap-12 opacity-50 grayscale">
                        {/* Placeholders for logos */}
                        <h4 className="font-black text-gray-300">SAMSUNG</h4>
                        <h4 className="font-black text-gray-300">PFIZER</h4>
                        <h4 className="font-black text-gray-300">BOEING</h4>
                        <h4 className="font-black text-gray-300">TESLA</h4>
                        <h4 className="font-black text-gray-300">SHELL</h4>
                    </div>
                </div>
            </div>
        </div>
