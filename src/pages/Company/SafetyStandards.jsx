        ...
        <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 font-sans">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                ...
                <div className="text-center mb-20">
                    <h1 className="font-black mb-6">Safety First. <br /> Always.</h1>
                    <h5 className="text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-gray-50 dark:bg-[#111] p-8 rounded-2xl border-l-8 border-[#799851]">
                        <h3 className="font-bold mb-4">Comprehensive Training</h3>
                    ...
                    {/* Card 2 */}
                    <div className="bg-gray-50 dark:bg-[#111] p-8 rounded-2xl border-l-8 border-[#799851]">
                        <h3 className="font-bold mb-4">PPE Standards</h3>
                    ...
                    {/* Card 3 */}
                    <div className="bg-gray-50 dark:bg-[#111] p-8 rounded-2xl border-l-8 border-[#799851]">
                        <h3 className="font-bold mb-4">Emergency Response</h3>
                    ...
                    {/* Card 4 */}
                    <div className="bg-gray-50 dark:bg-[#111] p-8 rounded-2xl border-l-8 border-[#799851]">
                        <h3 className="font-bold mb-4">Regular Audits</h3>
                    ...
                    {/* Card 5 */}
                    <div className="bg-gray-50 dark:bg-[#111] p-8 rounded-2xl border-l-8 border-[#799851]">
                        <h3 className="font-bold mb-4">Health Monitoring</h3>
                    ...
                    {/* Card 6 */}
                    <div className="bg-gray-50 dark:bg-[#111] p-8 rounded-2xl border-l-8 border-[#799851]">
                        <h3 className="font-bold mb-4">Zero Accident Goal</h3>
