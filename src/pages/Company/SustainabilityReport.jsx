        ...
        <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 font-sans">
            <div className="relative h-[50vh] min-h-[400px]">
                ...
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                    <div className="text-center text-white px-4">
                        <h1 className="font-bold mb-4">2025 Sustainability Report</h1>
                        <h5 className="max-w-2xl mx-auto">Measuring our impact, transparency in our progress.</h5>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                ...
                <div className="prose dark:prose-invert max-w-none mb-20 text-center">
                    <h2 className="font-bold">A Commitment to the Planet</h2>
                    <h6 className="text-gray-600 dark:text-gray-300 leading-relaxed max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
                    <div className="p-8 bg-green-50 dark:bg-green-900/20 rounded-2xl text-center">
                        <h2 className="font-bold text-[#799851] mb-2">50k+</h2>
                        <p className="font-semibold text-gray-700 dark:text-gray-300">Tons Diverted</p>
                    </div>
                    <div className="p-8 bg-green-50 dark:bg-green-900/20 rounded-2xl text-center">
                        <h2 className="font-bold text-[#799851] mb-2">12M</h2>
                        <p className="font-semibold text-gray-700 dark:text-gray-300">kWh Energy Saved</p>
                    </div>
                    <div className="p-8 bg-green-50 dark:bg-green-900/20 rounded-2xl text-center">
                        <h2 className="font-bold text-[#799851] mb-2">35%</h2>
                        <p className="font-semibold text-gray-700 dark:text-gray-300">Carbon Reduction</p>
                    </div>
                    <div className="p-8 bg-green-50 dark:bg-green-900/20 rounded-2xl text-center">
                        <h2 className="font-bold text-[#799851] mb-2">100%</h2>
                        <p className="font-semibold text-gray-700 dark:text-gray-300">Compliance Rate</p>
                    </div>
                </div>
                ...
                <div className="bg-[#111] rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden">
                    <div className="relative z-10">
                        <h2 className="font-bold mb-6">Read the Full Report</h2>
