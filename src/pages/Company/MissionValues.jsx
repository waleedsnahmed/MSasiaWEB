        ...
        <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 font-sans">
            ...
            <div className="relative py-16 lg:py-24 bg-gray-50 dark:bg-[#111] overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h4 className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <h2 className="font-bold mb-6">Mission Statement</h2>
                        <h6 className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                        ...
                        <h6 className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <section className="py-16 bg-gray-50 dark:bg-[#0a0a0a]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="font-bold mb-4">Core Values</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 bg-white dark:bg-[#111] rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 hover:border-[#799851] transition-all group">
                                ...
                                <h3 className="font-bold mb-3">{val.title}</h3>
