                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                        ...
                        <div className="lg:col-span-8 space-y-20 lg:space-y-24">
                            ...
                            <section className="space-y-6 animate-fadeIn">
                                ...
                                <h2 className="font-montserrat font-extrabold leading-[1.15] tracking-tight">
                                ...
                                <div className="prose prose-lg prose-gray dark:prose-invert max-w-none pt-4">
                                    <h4 className="text-gray-700 dark:text-gray-300 leading-relaxed font-light font-sans">
                                        {data.description}
                                    </h4>
                                    <p className="text-gray-500 dark:text-gray-400 leading-relaxed mt-6 font-sans">
                            ...
                            <section className="space-y-8 lg:space-y-10 animate-fadeInUp">
                                <div className="border-b border-gray-200 dark:border-gray-800 pb-4">
                                    <h4 className="font-montserrat font-bold text-gray-900 dark:text-white">
                                        Core Capabilities
                                    </h4>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                                    {data.features && data.features.map((feature, i) => (
                                        <div key={i} className="group flex flex-col items-start p-8 rounded-3xl bg-white dark:bg-[#111111] border border-gray-100 dark:border-white/5 hover:border-gray-200 dark:hover:border-white/10 transition-all duration-500 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.08)] dark:shadow-none dark:hover:shadow-[0_8px_32px_-8px_rgba(255,255,255,0.02)] relative overflow-hidden">
                                            ...
                                            <h5 className="font-bold text-gray-900 dark:text-white mb-3 font-montserrat tracking-tight relative z-10 group-hover:text-[#47622A] dark:group-hover:text-[#799851] transition-colors">
                                                {feature}
                                            </h5>
                                                ...
                                                <div key={idx} className={`relative flex flex-col md:flex-row items-start md:items-center w-full ${isEven ? 'md:flex-row-reverse' : ''} md:py-8`}>
                                                    ...
                                                    <div className={`w-full md:w-[50%] pl-12 md:pl-0 ${isEven ? 'md:pr-14' : 'md:pl-14'}`}>
                                                        <div className="bg-white dark:bg-[#111111] p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] dark:shadow-none hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.08)] transition-all duration-500 group">
                                                            ...
                                                            <h5 className={`font-bold text-gray-900 dark:text-white mb-3 font-montserrat tracking-tight ${isEven ? 'md:text-right' : 'text-left'}`}>
                                                                {step.title}
                                                            </h5>
                            ...
                            <section className="bg-gradient-to-br from-[#111111] to-[#0a0a0a] rounded-3xl lg:rounded-[2rem] p-8 lg:p-12 text-white shadow-xl animate-fadeInUp border border-gray-800 relative overflow-hidden">
                                ...
                                <div className="mb-10 relative z-10 text-center lg:text-left flex flex-col items-center lg:items-start">
                                    <h2 className="font-montserrat font-black tracking-tight mb-4">
                                        The MS Asia Advantage
                                    </h2>
                                    <h3 className="text-gray-400 max-w-2xl font-sans font-light">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 relative z-10">
                                    <div className="bg-white/5 dark:bg-white/[0.02] backdrop-blur-md p-8 rounded-3xl border border-white/10 dark:border-white/5 hover:bg-white/10 dark:hover:bg-white/[0.05] transition-all duration-500 group">
                                        ...
                                        <h6 className="font-bold font-montserrat text-white tracking-wide mb-3">Regulatory Excellence</h6>
                                        <p className="text-gray-400 font-sans text-[15px] leading-relaxed font-light share-text-color">Absolute adherence to global safety protocols, protecting your organization from regulatory liabilities and ensuring peace of mind.</p>
                                    </div>
                                    ...
                                    <div className="bg-white/5 dark:bg-white/[0.02] backdrop-blur-md p-8 rounded-3xl border border-white/10 dark:border-white/5 hover:bg-white/10 dark:hover:bg-white/[0.05] transition-all duration-500 group">
                                        ...
                                        <h6 className="font-bold font-montserrat text-white tracking-wide mb-3">Data-Driven Precision</h6>
                                        <p className="text-gray-400 font-sans text-[15px] leading-relaxed font-light share-text-color">Real-time reporting and detailed analytics ensuring transparent operations, full traceability, and measurable efficiency gains.</p>
                                    </div>
                                    ...
                                    <div className="bg-white/5 dark:bg-white/[0.02] backdrop-blur-md p-8 rounded-3xl border border-white/10 dark:border-white/5 hover:bg-white/10 dark:hover:bg-white/[0.05] transition-all duration-500 group">
                                        ...
                                        <h6 className="font-bold font-montserrat text-white tracking-wide mb-3">Zero-Impact Goals</h6>
                                        <p className="text-gray-400 font-sans text-[15px] leading-relaxed font-light share-text-color">Championing the circular economy by pushing zero-landfill initiatives and maximizing resource recovery across all managed facilities.</p>
                                    </div>
                                </div>
                            </section>
                        </div>
                        ...
                        <aside className="lg:col-span-4 lg:sticky lg:top-32 animate-fadeInRight">
                            <div className="bg-gradient-to-b from-[#111111] to-[#0a0a0a] border border-white/5 rounded-[2rem] p-10 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                                ...
                                <h4 className="font-montserrat font-bold text-white mb-4 tracking-tight relative z-10">
