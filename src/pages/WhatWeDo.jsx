        ...
        <div className="pt-24 min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300 font-sans pb-20">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 py-16 px-4 mb-12">
                <div className="max-w-7xl mx-auto text-center">
                    <h1 className="font-extrabold text-gray-900 dark:text-white mb-6">
                        What We Do
                    </h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {category.items.map((item, i) => (
                                ...
                                >
                                    ...
                                    <h6 className="font-bold text-gray-900 dark:text-white mb-2 group-hover:text-[#47622A] dark:group-hover:text-[#799851] transition-colors">
                                        {item.label}
                                    </h6>
