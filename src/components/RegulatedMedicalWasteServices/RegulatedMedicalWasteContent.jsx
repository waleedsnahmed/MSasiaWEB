...
import './RegulatedMedicalWasteContent.css';

// Direct import for Hero as it's the first thing seen
import RegulatedMedicalWasteHero from './RegulatedMedicalWasteHero';

// Lazy load the rest of the page components
const RegulatedMedicalWasteWhyChooseUs = lazy(() => import('./RegulatedMedicalWasteWhyChooseUs'));
const RegulatedMedicalWasteProcess = lazy(() => import('./RegulatedMedicalWasteProcess'));
const RegulatedMedicalWasteCategories = lazy(() => import('./RegulatedMedicalWasteCategories'));
const RegulatedMedicalWasteIndustries = lazy(() => import('./RegulatedMedicalWasteIndustries'));
const RegulatedMedicalWasteBenefits = lazy(() => import('./RegulatedMedicalWasteBenefits'));
const RegulatedMedicalWasteContactCTA = lazy(() => import('./RegulatedMedicalWasteContactCTA'));

const RegulatedMedicalWasteContent = () => {
