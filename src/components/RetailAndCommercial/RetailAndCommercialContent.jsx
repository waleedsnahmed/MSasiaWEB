...
import './RetailAndCommercialContent.css';

// Direct import for Hero as it's the first thing seen
import RetailAndCommercialHero from './RetailAndCommercialHero';

// Lazy load the rest of the page components
const RetailAndCommercialWhyChooseUs = lazy(() => import('./RetailAndCommercialWhyChooseUs'));
const RetailAndCommercialProcess = lazy(() => import('./RetailAndCommercialProcess'));
const RetailAndCommercialCategories = lazy(() => import('./RetailAndCommercialCategories'));
const RetailAndCommercialIndustries = lazy(() => import('./RetailAndCommercialIndustries'));
const RetailAndCommercialBenefits = lazy(() => import('./RetailAndCommercialBenefits'));
const RetailAndCommercialContactCTA = lazy(() => import('./RetailAndCommercialContactCTA'));

const RetailAndCommercialContent = () => {
