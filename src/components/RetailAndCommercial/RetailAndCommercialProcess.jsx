...
import { ClipboardCheck, LayoutTemplate, Truck, ShieldCheck, Recycle, Award } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'We conduct an in-depth Pharmacy Waste Assessment to define specific waste types across all service areas. We implement a custom Segregation Program with compliant, discreet containers placed to align perfectly with dispensing workflows.',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'Staff Training & Containerization',
    description: 'We specify and provide compliant, DOT-approved containers tailored for retail spaces. We also provide initial and annual refresher training modules for pharmacy technicians to ensure accurate separation of hazardous substances.',
    icon: LayoutTemplate,
  ...
  {
    number: 3,
    title: 'Secure Collection & Logistics',
    description: 'We offer scheduled and on-demand collection designed to minimize disruption to retail hours. All materials are moved via licensed vehicles by highly trained personnel following strict, traceable chain-of-custody protocols.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Controlled Substance Handling',
    description: 'We provide DEA-compliant secure transport or on-site witnessed destruction of controlled substances. This ensures absolute legal closure, prevents any medication diversion, and eliminates liability risks.',
    icon: ShieldCheck,
  ...
  {
    number: 5,
    title: 'Advanced Destruction & Recovery',
    description: 'Hazardous and non-hazardous pharmaceuticals are sent to permitted, high-temperature incineration facilities. We also manage reverse distribution logistics and ensure compliant treatment of sharps and biohazardous waste.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'We provide an audit-ready Pharmacy Compliance Dossier including complete EPA Manifests, Certificates of Destruction, and DEA Forms. This flawless documentation ensures full inspection readiness for state boards of pharmacy.',
    icon: Award,
...
const RetailAndCommercialProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="retail-commercial-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="retail-commercial-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        End-to-End Pharmacy Waste Management Process
                    </motion.h2>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Our structured, phase-based system integrates seamlessly into pharmacy workflow, from the back counter to final destruction.
                    </motion.p>
                </div>
...
export default RetailAndCommercialProcess;
