...
import { Search, LayoutTemplate, Calendar, Truck, Recycle, FileCheck } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'Detailed review of manufacturing processes, material flows, and specific waste streams to define needs.',
    icon: Search,
  ...
  },
  {
    ...
    description: 'Placement of specialized containers at production and maintenance areas to ensure proper segregation.',
    icon: LayoutTemplate,
  ...
  },
  {
    ...
    description: 'Reliable pickups aligned precisely with production schedules to prevent any disruption to workflow.',
    icon: Calendar,
  ...
  },
  {
    ...
    description: 'All materials are moved securely via licensed vehicles operated by highly trained, certified personnel.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Advanced recycling, recovery, or compliant landfill disposal based precisely on the waste type.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'Providing full traceability, audit-ready compliance records, and comprehensive regulatory support.',
    icon: FileCheck,
...
const GeneralManufacturingProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="general-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="general-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Managing waste without disrupting your production lines.
                    </motion.p>
                </div>
...
export default GeneralManufacturingProcess;
