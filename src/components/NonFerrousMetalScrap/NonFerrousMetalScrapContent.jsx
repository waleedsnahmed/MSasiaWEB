...
import './NonFerrousMetalScrapContent.css';

// Direct import for Hero as it's the first thing seen
import NonFerrousMetalScrapHero from './NonFerrousMetalScrapHero';

// Lazy load the rest of the page components
const NonFerrousMetalScrapWhyChooseUs = lazy(() => import('./NonFerrousMetalScrapWhyChooseUs'));
const NonFerrousMetalScrapProcess = lazy(() => import('./NonFerrousMetalScrapProcess'));
const NonFerrousMetalScrapCategories = lazy(() => import('./NonFerrousMetalScrapCategories'));
const NonFerrousMetalScrapIndustries = lazy(() => import('./NonFerrousMetalScrapIndustries'));
const NonFerrousMetalScrapBenefits = lazy(() => import('./NonFerrousMetalScrapBenefits'));
const NonFerrousMetalScrapContactCTA = lazy(() => import('./NonFerrousMetalScrapContactCTA'));

const NonFerrousMetalScrapContent = () => {
    // Non-Ferrous Metal specific state/effects
    useEffect(() => {
        const handleScroll = () => {
