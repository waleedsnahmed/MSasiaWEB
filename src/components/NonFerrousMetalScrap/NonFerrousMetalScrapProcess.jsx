...
import { Microscope, Tags, Truck, Settings2, Recycle } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Advanced Material Identification',
    description: 'Detailed inspection using professional tools like XRF analysis to verify precise alloy composition and audit contamination levels.',
    icon: Microscope,
  ...
  {
    number: 2,
    title: 'Precision Segregation',
    description: 'Manual and mechanical removal of ferrous attachments and strict source separation into dedicated, labeled containers.',
    icon: Tags,
  ...
  },
  {
    ...
    description: 'Dedicated covered vehicles and planned logistics schedules minimize site disruption and ensure material is transported safely.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Processing and Sizing',
    description: 'Scrap undergoes advanced mechanical sorting, de-oiling, cutting, and shredding to prepare for high-efficiency melting.',
    icon: Settings2,
  ...
  },
  {
    ...
    description: 'Conserves finite raw materials and reduces environmental impact by refining recovered metals directly into stock supply chains.',
    icon: Recycle,
...
const NonFerrousMetalScrapProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="NonFerrousMetalScrap-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="NonFerrousMetalScrap-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
...
export default NonFerrousMetalScrapProcess;
