...
import { Target, Layers, Settings, Truck, Gem, Sprout, FileCheck, CalendarClock } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'Every project starts with a physical inspection to identify scrap categories, hazard-prone areas, worn-out components, and loading requirements, creating a safe operational map.',
    icon: Target,
  ...
  {
    number: 2,
    title: 'Safe Collection & Segregation',
    description: 'We bring trained personnel and certified handling procedures to collect and segregate multiple waste streams—preventing contamination and increasing recycling yield directly at the source.',
    icon: Layers,
  ...
  {
    number: 3,
    title: 'Heavy-Duty Dismantling',
    description: 'We safely manage machinery tear-downs, cutting of heavy structures, HVAC dismantling, and the physical separation of metal-concrete composites using advanced techniques.',
    icon: Settings,
  ...
  },
  {
    ...
    description: 'Industrial scrap is not light. We deploy heavy equipment including hydra cranes, excavators, tippers, and hook loaders to move your scrap without disrupting active operations.',
    icon: Truck,
  ...
  {
    number: 5,
    title: 'High-Value Material Recovery',
    description: 'We expertly extract maximum value by recovering ferrous and non-ferrous metals, structural alloys, reusable steel materials, and mechanical components from the wreckage.',
    icon: Gem,
  ...
  {
    number: 6,
    title: 'Eco-Friendly Reprocessing',
    description: 'Everything collected goes through certified recycling channels where materials are cleaned, shredded, smelted, and packed for circular reuse, meeting core sustainability goals.',
    icon: Sprout,
  ...
  },
  {
    ...
    description: 'We provide full traceability through waste transfer notes, compliance reports, recycling certificates, and hazard clearance papers, ensuring you remain entirely audit-ready.',
    icon: FileCheck,
  ...
  },
  {
    ...
    description: 'For ongoing facilities, we establish scheduled pickup services—weekly, bi-weekly, or on-demand—guaranteeing you never have to deal with waste buildup again.',
    icon: CalendarClock,
...
const ConstructionDemolitionProcess = () => {
        ...
        <section id="roadmap-process" className="ewaste-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="ewaste-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        We clear industrial environments with a structured system designed to reduce downtime and strictly maintain environmental and safety compliance.
                    </motion.p>
                </div>
...
export default ConstructionDemolitionProcess;
