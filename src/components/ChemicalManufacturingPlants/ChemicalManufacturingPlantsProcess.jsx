...
import { Search, Boxes, Calendar, Truck, Flame, FileCheck } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'Detailed review of processes, chemical compatibility, hazard classifications, and all applicable regulations.',
    icon: Search,
  ...
  },
  {
    ...
    description: 'Implementing safe containment, precise labeling systems, and secondary containment to prevent dangerous leaks and spills.',
    icon: Boxes,
  ...
  },
  {
    ...
    description: 'Flexible, on-demand, or scheduled pickups perfectly aligned with your complex production cycles and batch changes.',
    icon: Calendar,
  ...
  },
  {
    ...
    description: 'Strict chain-of-custody transport via licensed hazardous waste vehicles operated by highly trained professionals.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Authorized processing including neutralization, high-temperature incineration, secure recycling, or stabilized landfilling.',
    icon: Flame,
  ...
  },
  {
    ...
    description: 'Providing comprehensive chain-of-custody documentation, manifests, and audit-ready records to demonstrate full compliance.',
    icon: FileCheck,
...
const ChemicalManufacturingPlantsProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="chemical-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="chemical-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Managing the complete lifecycle of hazardous waste from on-site collection to final treatment.
                    </motion.p>
                </div>
...
export default ChemicalManufacturingPlantsProcess;
