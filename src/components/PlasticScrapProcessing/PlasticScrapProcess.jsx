...
import { ClipboardCheck, Trash2, Truck, Scan, Settings, Factory } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Waste Evaluation & Planning',
    description: 'Our team assesses your plastic types, volumes, contamination levels, and storage conditions. This allows us to design a tailored processing and recycling plan and determine collection frequency.',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'On-Site Collection & Segregation',
    description: 'We implement rigorous plastic type segregation through dedicated containers, clear labeling systems, and training guidance. Proper segregation significantly improves recycling outcomes.',
    icon: Trash2,
  ...
  },
  {
    ...
    description: 'Plastic scrap is safely transported using covered, secured vehicles with separate containers for different plastic variations and scheduled pickups to ensure cleanliness and traceability.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Sorting & Decontamination',
    description: 'Collected plastics undergo manual and mechanical sorting to remove labels, metals, and contaminants. Advanced washing and drying systems clean the plastics, dramatically increasing market value.',
    icon: Scan,
  ...
  {
    number: 5,
    title: 'Size Reduction & Shredding',
    description: 'After cleaning, plastics are processed through high-performance shredders and granulators to reduce them into smaller flakes or chips, and are compacted or baled for further refinement.',
    icon: Settings,
  ...
  {
    number: 6,
    title: 'Melting, Reprocessing & QC',
    description: 'The shredded plastic is melted and reprocessed using extrusion to create raw materials like pellets or granules. Strict quality checks are performed to ensure compliance with industry specifications.',
    icon: Factory,
...
const PlasticScrapProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="plastic-scrap-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="plastic-scrap-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Plastic Scrap Processing Workflow
                    </motion.h2>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        An organized, secure chain of custody transforming discarded bulk plastics into premium manufacturing resources.
                    </motion.p>
                </div>
...
export default PlasticScrapProcess;
