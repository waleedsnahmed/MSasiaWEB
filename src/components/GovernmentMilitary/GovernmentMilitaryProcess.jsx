...
import { ShieldCheck, Target, Truck, Flame, Trash2, FileText } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Planning & Security Integration',
    description: 'Operational Assessment and customized Waste Management Planning aligned directly with mission needs.',
    icon: ShieldCheck,
  ...
  {
    number: 2,
    title: 'Secure Segregation',
    description: 'Placement of controlled containers and secure storage areas for sensitive materials.',
    icon: Target,
  ...
  },
  {
    ...
    description: 'Scheduled pickups coordinated with base security, utilizing vetted personnel and licensed vehicles.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Materials are safely contained, transported, and routed to approved treatment facilities for disposal.',
    icon: Flame,
  ...
  {
    number: 5,
    title: 'Sensitive Asset Destruction',
    description: 'Controlled disposal, certified data destruction, and secure recycling of highly sensitive electronic assets.',
    icon: Trash2,
  ...
  },
  {
    ...
    description: 'Documentation and reporting for full traceability, security clearances, and complete audit support.',
    icon: FileText,
...
const GovernmentMilitaryProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="gov-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="gov-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Ensuring security and compliance at every stage of the waste lifecycle.
                    </motion.p>
                </div>
...
export default GovernmentMilitaryProcess;
