...
import './GovernmentMilitaryContent.css';

// Direct import for Hero as it's the first thing seen
import GovernmentMilitaryHero from './GovernmentMilitaryHero';

// Lazy load the rest of the page components
const GovernmentMilitaryWhyChooseUs = lazy(() => import('./GovernmentMilitaryWhyChooseUs'));
const GovernmentMilitaryProcess = lazy(() => import('./GovernmentMilitaryProcess'));
const GovernmentMilitaryCategories = lazy(() => import('./GovernmentMilitaryCategories'));
const GovernmentMilitaryIndustries = lazy(() => import('./GovernmentMilitaryIndustries'));
const GovernmentMilitaryBenefits = lazy(() => import('./GovernmentMilitaryBenefits'));
const GovernmentMilitaryContactCTA = lazy(() => import('./GovernmentMilitaryContactCTA'));

const GovernmentMilitaryContent = () => {
