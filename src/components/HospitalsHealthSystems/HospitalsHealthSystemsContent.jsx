...
import './HospitalsHealthSystemsContent.css';

// Direct import for Hero as it's the first thing seen
import HospitalsHealthSystemsHero from './HospitalsHealthSystemsHero';

// Lazy load the rest of the page components
const HospitalsHealthSystemsWhyChooseUs = lazy(() => import('./HospitalsHealthSystemsWhyChooseUs'));
const HospitalsHealthSystemsProcess = lazy(() => import('./HospitalsHealthSystemsProcess'));
const HospitalsHealthSystemsCategories = lazy(() => import('./HospitalsHealthSystemsCategories'));
const HospitalsHealthSystemsIndustries = lazy(() => import('./HospitalsHealthSystemsIndustries'));
const HospitalsHealthSystemsBenefits = lazy(() => import('./HospitalsHealthSystemsBenefits'));
const HospitalsHealthSystemsContactCTA = lazy(() => import('./HospitalsHealthSystemsContactCTA'));

const HospitalsHealthSystemsContent = () => {
