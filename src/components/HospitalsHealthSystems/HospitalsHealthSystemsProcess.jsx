...
import { Search, Boxes, Truck, Stethoscope, ShieldCheck, BarChart } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Strategic Assessment & Network Design',
    description: 'We conduct a deep-dive mapping of physical supply chains, waste streams, and clinical workflows, engaging with your teams to align logistics with patient care pathways.',
    icon: Search,
  ...
  {
    number: 2,
    title: 'Intelligent Inventory & Storage',
    description: 'We optimize central and decentralized distribution centers while deploying color-coded containers, sharps boxes, and secure storage for complex waste streams.',
    icon: Boxes,
  ...
  {
    number: 3,
    title: 'Integrated In-Hospital Logistics',
    description: 'Scheduled delivery waves and routine waste pickups are aligned with nursing shifts to prevent accumulation and ensure point-of-use integration without disrupting care.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Specialty Service Line Operations',
    description: 'End-to-end management of surgical procedure trays, implant logistics, IV room logistics, and the secure handling of hazardous chemical and laboratory waste.',
    icon: Stethoscope,
  ...
  {
    number: 5,
    title: 'Secure Processing & Transportation',
    description: 'Using sanitized transport containers, we utilize licensed vehicles to move regulated medical waste for safe treatment via autoclaving, chemical neutralization, or incineration.',
    icon: ShieldCheck,
  ...
  {
    number: 6,
    title: 'Performance Analytics & Compliance',
    description: 'Our unified data platform links supply spend to patient outcomes while providing complete traceability and regulatory reporting for all waste streams.',
    icon: BarChart,
...
const HospitalsHealthSystemsProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="hospitals-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="hospitals-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        End-to-End Logistics Framework
                    </motion.h2>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        A synchronized system engineered to support rapid delivery of quality healthcare through intelligent operations.
                    </motion.p>
                </div>
...
export default HospitalsHealthSystemsProcess;
