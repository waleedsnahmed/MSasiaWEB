...
const phases = [
  {
    ...
    description: 'Our experts conduct thorough evaluations of your machinery to identify valuable components and formulate a customized, highly efficient dismantling strategy.',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'Safe & Controlled Dismantling',
    description: 'Executed by trained professionals, our dismantling process utilizes specialized tools and strictly adheres to industry safety standards to mitigate on-site risks.',
    icon: Truck,
  ...
  {
    number: 3,
    title: 'Meticulous Segregation',
    description: 'Every component is carefully separated and categorized. This ensures efficient recycling and maximizes the recovery yield of valuable metals and reusable parts.',
    icon: MapPin,
  ...
  {
    number: 4,
    title: 'Secure Logistics & Transport',
    description: 'All scrap materials are safely transported using certified logistics networks to our authorized recycling facilities.',
    icon: Cog,
  ...
  },
  {
    ...
    description: 'We employ cutting-edge extraction techniques to recover usable metals, minimizing overall waste. Any hazardous elements are handled and disposed of in strict compliance with environmental safety guidelines.',
    icon: Recycle,
...
const IndustrialMachineryScrapProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="IndustrialMachineryScrap-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="IndustrialMachineryScrap-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
...
export default IndustrialMachineryScrapProcess;
