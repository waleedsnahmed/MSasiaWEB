...
import { Search, Zap, Hammer, Truck, FileText } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Source Analysis & Classification',
    description: 'We conduct detailed sourcing analysis, differentiating between machining turnings and demolition components, while providing custom labeling for on-site segregation.',
    icon: Search,
  ...
  {
    number: 2,
    title: 'Advanced XRF Lab Verification',
    description: 'Using handheld XRF Spectrometers, we provide instant chemical readouts accurate to 0.01% to quantify copper, zinc, and tin content definitively.',
    icon: Zap,
  ...
  {
    number: 3,
    title: 'Specialized High-Pressure Processing',
    description: 'Machining turnings are compressed into solid, 300-ton briquettes. This removes moisture and cutting fluids, creating dense, furnace-ready feedstock with zero melt loss.',
    icon: Hammer,
  ...
  {
    number: 4,
    title: 'Certified Packaging & Distribution',
    description: 'Materials are lot-certified with Material Test Certificates (MTC) and channeled directly to high-paying specialty art, marine, or industrial foundries.',
    icon: Truck,
  ...
  {
    number: 5,
    title: 'LME Settlement & Settlement',
    description: 'Valuation is anchored to real-time London Metal Exchange (LME) copper rates, providing transparent, composition-based premiums for pure alloy lots.',
    icon: FileText,
        ...
        <section id="roadmap-process" className="ewaste-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="ewaste-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        We move beyond generic trading, employing precise metallurgical sorting to supply high-quality secondary raw materials essential for India’s circular economy.
                    </motion.p>
                </div>
...
export default BrassBronzeScrapProcess;
