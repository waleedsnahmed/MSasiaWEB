...
import { Microscope, AlertTriangle, ThermometerSnowflake, DollarSign } from 'lucide-react';

const whyPoints = [
    {
        icon: AlertTriangle,
        title: 'Zinc Contamination in Bronze',
        description: 'Improper sorting lowers the melting point of bronze scrap, compromising its extreme industrial strength and critical corrosion resistance.',
    },
    {
        icon: ThermometerSnowflake,
        title: 'Tin in Brass Production',
        description: 'Unwanted tin accumulation increases hardness and reduces machinability, triggering tool wear and severe surface finish issues in manufacturing.',
    },
    {
        icon: Microscope,
        title: 'Lead Content Confusion',
        description: 'Mixing leaded brass with lead-free varieties creates products that fail international drinking water standards and safety audits.',
    },
    {
        icon: DollarSign,
        title: 'Massive Financial Impact',
        description: 'Generic mixed "yellow scrap" sells at a 30-50% discount compared to properly identified, pure Red Brass or Gunmetal grades.',
    },
];

const BrassBronzeScrapWhyChooseUs = () => {
    return (
        <section className="ewaste-why bg-white dark:bg-black !py-0">
            <div className="ewaste-why__container max-w-screen-2xl mx-0 md:mx-auto px-0 flex flex-col gap-4 md:gap-[24px]">
                <div className="ewaste-why__header text-center flex flex-col items-center justify-start gap-2 md:gap-4 scroll-reveal">
                    <h6 className="ewaste-why__label text-[#47622A] dark:text-[#799851] uppercase">The High Cost of Mixing</h6>
                    <h2 className="ewaste-why__heading !text-transparent !bg-clip-text bg-gradient-to-r from-[#47622A] to-[#799851]">
                        The Science of Alloy Separation
                    </h2>
                    <p className="ewaste-why__subtitle dark:text-gray-400 text-gray-600 max-w-none">
                        Brass and bronze are complex copper-based alloys. Their recovery requires technical precision; mixing grades significantly destroys the resulting metal integrity and value.
                    </p>
                </div>
                ...
                <div className="ewaste-why__cta-wrapper flex justify-center scroll-reveal">
                    <div className="ewaste-why__cta-banner w-full max-w-[1152px] p-4 md:p-[24px] rounded-3xl bg-gradient-to-r from-[#47622A] to-[#799851] dark:!bg-none dark:bg-black text-white relative overflow-hidden">
                        <div className="ewaste-why__cta-text relative z-10 flex flex-col items-center text-center lg:items-start lg:text-left gap-2 md:gap-[16px]">
                            <h4 className="ewaste-why__cta-strong block text-white font-bold">Our Technical Solution</h4>
                            <p className="font-semibold text-white/90">We function as a metallurgical sorting facility, applying scientific analysis to preserve and enhance the intrinsic value of each individual alloy stream.</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default BrassBronzeScrapWhyChooseUs;
