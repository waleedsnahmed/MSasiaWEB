...
import { ClipboardCheck, Droplets, Crosshair, Grid, Truck, ScrollText } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Assessment & Engineering Plan',
    description: 'We conduct rigorous hazard audits, evaluating structural layout, weight distribution, and connection points to author a customized, step-by-step Site-Specific Safety Plan (SSSP).',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'Decommissioning & Fluid Recovery',
    description: 'Strict Lockout/Tagout (LOTO) protocols isolate energy. We vacuum-drain hydrocarbons, coolants, and hydraulic fluids, removing batteries to prevent environmental contamination.',
    icon: Droplets,
  ...
  {
    number: 3,
    title: 'Strategic Dismantling',
    description: 'Using exothermic lances, hydraulic shears, and certified welders, we break the machine down into transportable sections, performing salvage extraction for reusable components.',
    icon: Crosshair,
  ...
  {
    number: 4,
    title: 'On-Site Material Segregation',
    description: 'Materials are immediately sorted on-site into high-value streams: heavy steel plate, cast iron, copper wiring, and aluminum, isolating all non-metallics.',
    icon: Grid,
  ...
  },
  {
    ...
    description: 'Specialized 250-ton mobile cranes and low-bed trailers are deployed to maneuver and securely transport massive structural sections away from your congested operations.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'You receive total protection via a project closure report detailing certified weighbridge tickets, environmental fluid disposal manifests, and destruction certificates.',
    icon: ScrollText,
...
const HeavyEquipmentScrapProcess = () => {
        ...
        <section id="roadmap-process" className="ewaste-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="ewaste-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Safely isolating hazards and executing high-tonnage extractions without disrupting your ongoing industrial operations.
                    </motion.p>
                </div>
...
export default HeavyEquipmentScrapProcess;
