...
const HeavyEquipmentScrapContactCTA = () => {
    return (
                    ...
                    <div className="ewaste-contact__content-wrapper flex justify-center w-full relative z-10">
                        <div className="flex flex-col gap-2 md:gap-6 items-center w-full max-w-[1152px]">
                            <h2 className="ewaste-contact__heading text-white font-bold">
                                Ensure Safe, Compliant Asset Retirement.
                            </h2>
                            <p className="ewaste-contact__subtitle text-white/90 max-w-none">
                                Turn massive industrial liabilities into profitable material recovery. Connect with our heavy dismantlement engineers for a detailed site hazard assessment today.
                            </p>

                            <div className="ewaste-contact__actions flex flex-col gap-[16px] justify-center items-center w-full">
                                <a
                                    href="/contact"
                                    className="ewaste-contact__btn group h-[44px] w-[260px] max-w-full rounded-xl bg-white !text-[#47622A] hover:shadow-lg transition-all flex items-center justify-center gap-2"
                                >
                                    <p className="text-[#3d5220] dark:text-[#3d5220]">Request Engineering Survey</p>
...
export default HeavyEquipmentScrapContactCTA;
