...
import { ClipboardCheck, Box, Truck, Settings, TrendingUp } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Waste Assessment & Safety Planning',
    description: 'Given the high-risk nature of rubber stockpiles, our initial assessment aligns your practices with national ELT regulations and evaluates exact volumes against vital fire prevention standards.',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'On-Site Collection & Storage',
    description: 'We deploy secure containers tailored for bulky waste to stop illegal dumping, advising strongly on safe stacking limits and pest-breeding water prevention leading up to scheduled removal.',
    icon: Box,
  ...
  {
    number: 3,
    title: 'Secure Fleet Logistics',
    description: 'Rubber scrap is transported under strict fire safety compliance and load containment procedures, ensuring fully documented, controlled movements from your site to authorized processing centers.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Advanced Size Reduction',
    description: 'The core of rubber recycling is executed here, involving mechanical tire debeading, steel bead wire separation, and systematic volume reduction through high-torque industrial shredding grinds.',
    icon: Settings,
  ...
  {
    number: 5,
    title: 'Resource Recovery & Markets',
    description: 'Finished graded outputs such as Tire Derived Fuel (TDF), ambient Crumb Rubber, and certified Pyrolysis Oil are securely supplied back directly into high-value secondary industrial markets.',
    icon: TrendingUp,
...
const RubberTyreProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="rubber-tyre-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="rubber-tyre-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Complete Collection & Recovery Cycle
                    </motion.h2>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        We employ a combination of mechanical and thermal processes tailored flawlessly to India's compliance requirements.
                    </motion.p>
                </div>
...
export default RubberTyreProcess;
