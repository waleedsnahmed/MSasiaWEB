...
import { Factory, Microscope, Package, Droplet, Fuel, Pill, Building2, Beaker } from 'lucide-react';

const industries = [
    { icon: Factory, title: 'Manufacturing Plants', description: 'Expert packing of complex industrial waste streams and byproducts.' },
    { icon: Pill, title: 'Pharma & Biotech', description: 'Specialized containment for active pharmaceutical ingredients and lab waste.' },
    { icon: Beaker, title: 'Chemical Industries', description: 'Comprehensive scale solutions for volatile and reactive chemical disposal.' },
    { icon: Microscope, title: 'Research & Hospital Labs', description: 'Lab Pack services for safely handling thousands of mixed small-quantity reagents.' },
    { icon: Building2, title: 'Food & Beverage', description: 'Containment of cleaning chemicals, ammonia systems, and processing byproducts.' },
    { icon: Droplet, title: 'Paint & Coating', description: 'Safe extraction and sealing of highly flammable thinners, varnishes, and VoCs.' },
    { icon: Package, title: 'Warehousing Hubs', description: 'Rapid packing response for damaged or expired shipments stored directly within distribution centers.' },
    { icon: Fuel, title: 'Petrochemical & Automotive', description: 'Robust packaging of oils, sludge, and heavy lubricants to prevent soil contamination.' },
];

const ChemicalPackingIndustries = () => {
    return (
            ...
            <div className="ewaste-industries__container max-w-screen-2xl mx-0 md:mx-auto px-0 flex flex-col gap-4 md:gap-[24px]">
                <div className="ewaste-industries__header text-center flex flex-col items-center gap-2 md:gap-4 scroll-reveal">
                    ...
                    <p className="ewaste-industries__subtitle dark:text-gray-400 text-gray-600 max-w-3xl">
                        Any organization that generates, handles, or stores hazardous, expired, or surplus chemicals can dramatically reduce risk profiles by utilizing our expertise.
                    </p>
                </div>
...
export default ChemicalPackingIndustries;
