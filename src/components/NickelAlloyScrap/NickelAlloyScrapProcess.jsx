...
const phases = [
  {
    ...
    description: 'Our process begins with detailed material identification using advanced tools to accurately determine nickel content and specific alloy composition.',
    icon: ClipboardCheck,
  ...
  },
  {
    ...
    description: 'Our team follows strict protocols on-site to separate scrap by specific alloy type, remove non-metal attachments, and prevent cross-contamination.',
    icon: MapPin,
  ...
  },
  {
    ...
    description: 'High-value alloy scrap is transported securely using dedicated vehicles and labelled containers to protect material integrity during transit.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'At authorized facilities, the scrap undergoes intensive cleaning, de-oiling, and size reduction to meet the high standards required by specialty smelters.',
    icon: Cog,
  ...
  },
  {
    ...
    description: 'Processed nickel and alloy scrap is sent to certified units where metals are melted and refined for reuse, conserving scarce resources.',
    icon: Recycle,
...
const NickelAlloyScrapProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="NickelAlloyScrap-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="NickelAlloyScrap-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
...
export default NickelAlloyScrapProcess;
