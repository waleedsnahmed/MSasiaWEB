...
import { ClipboardCheck, ShieldCheck, Truck, Cog, CheckCircle, FileText } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Waste Assessment & Program Design',
    description: 'We conduct a detailed audit of your waste generation and infrastructure. We then deploy a customized plan featuring proper color-coded segregation protocols (Yellow, Red, White, Blue, Black bins), staff training, and compliance mapping.',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'Secure On-Site Management',
    description: 'We outfit your facility with secure, leak-proof containers and sharps safety systems. Scheduled collections are executed by trained personnel wearing appropriate PPE to prevent spills, exposure, or contamination while inside your facility.',
    icon: ShieldCheck,
  ...
  {
    number: 3,
    title: 'GPS-Tracked Logistics',
    description: 'Biohazardous waste is transported in dedicated, GPS-tracked vehicles equipped with leak-proof secondary containment and mandatory spill kits. A strict chain of custody is maintained using bar-coded tracking and digital manifests.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Waste undergoes primary treatment at our state-of-the-art facilities. Red/Yellow bag materials are neutralized via high-pressure steam autoclaving (121°C), while pathological items or pharmaceuticals face high-temperature dual-chamber incineration.',
    icon: Cog,
  ...
  {
    number: 5,
    title: 'Final Disposal & Resource Recovery',
    description: 'Treated plastics are shredded and ethically recycled where permitted. Inert incineration ash and non-recyclable sterilized materials are securely deposited in authorized engineered sanitary landfills in strict adherence to environmental guidelines.',
    icon: CheckCircle,
  ...
  },
  {
    ...
    description: 'You receive complete audit-ready documentation including treatment certificates for every batch, monthly summaries, and support for your mandatory Annual Returns, shielding your facility from liability and regulatory fines.',
    icon: FileText,
...
const BiohazardousWasteDisposalProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="biohaz-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="biohaz-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        End-to-End Waste Management System
                    </motion.h2>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        An integrated approach combining advanced technology and certified personnel for absolute safety.
                    </motion.p>
                </div>
...
export default BiohazardousWasteDisposalProcess;
