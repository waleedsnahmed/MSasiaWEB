...
import { ClipboardCheck, Package, Clock, MapPin, Cog, FileCheck } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Waste Assessment & Planning',
    description: 'We evaluate your clinic’s specific waste streams, patient volume, and compliance requirements to design the most efficient, tailored collection program for your practice.',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'Segregation & Storage Solutions',
    description: 'We supply color-coded bins, certified sharps containers, and compact amalgam collection kits designed to fit seamlessly into small treatment rooms and limited storage areas.',
    icon: Package,
  ...
  },
  {
    ...
    description: 'Routine, reliable pickups are scheduled to prevent waste accumulation, reduce in-clinic storage time, and maintain a cleaner environment without disrupting your workflow.',
    icon: Clock,
  ...
  },
  {
    ...
    description: 'Licensed, secure vehicles transport waste to authorized treatment and recycling facilities, maintaining an unbroken Chain of Custody to protect against regulatory liabilities.',
    icon: MapPin,
  ...
  },
  {
    ...
    description: 'Waste is processed via the most appropriate and compliant method: autoclaving for RMW, incineration for pharmaceuticals, or specialized recycling for mercury amalgam.',
    icon: Cog,
  ...
  },
  {
    ...
    description: 'Complete traceability and reporting to ensure compliance. We provide full manifests, tracking data, and Certificates of Destruction for absolute audit readiness.',
    icon: FileCheck,
...
const DentalVeterinaryClinicsProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="dental-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="dental-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        A Step-by-Step Compliance Process: We operate on a foundation of safety, security, and strict regulatory adherence.
                    </motion.p>
                </div>
...
export default DentalVeterinaryClinicsProcess;
