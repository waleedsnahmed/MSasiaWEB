...
import './DentalVeterinaryClinicsContent.css';

// Direct import for Hero as it's the first thing seen
import DentalVeterinaryClinicsHero from './DentalVeterinaryClinicsHero';

// Lazy load the rest of the page components
const DentalVeterinaryClinicsWhyChooseUs = lazy(() => import('./DentalVeterinaryClinicsWhyChooseUs'));
const DentalVeterinaryClinicsProcess = lazy(() => import('./DentalVeterinaryClinicsProcess'));
const DentalVeterinaryClinicsCategories = lazy(() => import('./DentalVeterinaryClinicsCategories'));
const DentalVeterinaryClinicsIndustries = lazy(() => import('./DentalVeterinaryClinicsIndustries'));
const DentalVeterinaryClinicsBenefits = lazy(() => import('./DentalVeterinaryClinicsBenefits'));
const DentalVeterinaryClinicsContactCTA = lazy(() => import('./DentalVeterinaryClinicsContactCTA'));

const DentalVeterinaryClinicsContent = () => {
