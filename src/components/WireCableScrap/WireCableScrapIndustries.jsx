...
import { Building2, Zap, Radio, Factory, Server, Plug, Anchor, Car } from 'lucide-react';

const industries = [
    { icon: Building2, title: 'Construction & Demolition', description: 'Handling high volumes of building wire and demolition cable scrap.' },
    { icon: Zap, title: 'Electrical Contractors', description: 'Reliable bulk collection for wiring firms and installation projects.' },
    { icon: Radio, title: 'Telecom & ISPs', description: 'Clean processing for high-grade communications and data cables.' },
    { icon: Factory, title: 'Factories', description: 'Industrial rewiring materials and machinery control cables.' },
    { icon: Server, title: 'IT Parks', description: 'Data center decommissioning and network infrastructure upgrades.' },
    { icon: Plug, title: 'Power Distribution (Discoms)', description: 'Safe recovery of aluminium and copper from overhead transmission lines.' },
    { icon: Anchor, title: 'Shipbreakers & Rail Yards', description: 'Heavy-duty insulated cables and mixed metal wire recovery.' },
    { icon: Car, title: 'Automotive Manufacturers', description: 'Specialized granulation for thin-gauge automotive wire harnesses.' },
];

const WireCableScrapIndustries = () => {
    return (
            ...
            <div className="ewaste-industries__container max-w-screen-2xl mx-0 md:mx-auto px-0 flex flex-col gap-4 md:gap-[24px]">
                <div className="ewaste-industries__header text-center flex flex-col items-center gap-2 md:gap-4 scroll-reveal">
                    ...
                    <h2 className="ewaste-industries__heading !text-transparent !bg-clip-text bg-gradient-to-r from-[#47622A] to-[#799851]">
                        Who Generates Wire & Cable Scrap?
                    </h2>
                    <p className="ewaste-industries__subtitle dark:text-gray-400 text-gray-600 max-w-3xl">
                        We are the ideal bulk processing partner for industrial generators across India.
                    </p>
                </div>
...
export default WireCableScrapIndustries;
