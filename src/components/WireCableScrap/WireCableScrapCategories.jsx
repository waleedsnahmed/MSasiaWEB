...
import { Cable, Zap, Radio, Phone, HardDrive, Cpu, Package } from 'lucide-react';

const categories = [
    {
        category: '#1 Bare Bright Copper',
        examples: 'Utility scrap, transformer windings.',
        handling: 'Clean, uncoated, unalloyed copper wire. Highest value.',
        icon: Zap,
    },
    {
        category: '#2 Copper Wire',
        examples: 'Household wiring, electronic cables.',
        handling: 'Insulated, unalloyed copper wire (thin gauge).',
        icon: Cable,
    },
    {
        category: 'Heavy Insulated Copper',
        examples: 'Power cables, armoured cable.',
        handling: 'Thick insulation, large diameter copper inside.',
        icon: HardDrive,
    },
    {
        category: (
            <>
                <span className="md:hidden">Communi-<br />cations Cable</span>
                <span className="hidden md:inline">Communications Cable</span>
            </>
        ),
        examples: 'IT offices, telecom upgrades.',
        handling: 'Multiple thin copper strands (Cat5/6, telecom).',
        icon: Phone,
    },
    {
        category: 'Aluminium Cable',
        examples: 'Overhead transmission lines, some building wire.',
        handling: 'Insulated aluminium wire.',
        icon: Radio,
    },
    {
        category: 'Automotive Wire',
        examples: 'Vehicle dismantling, auto plants.',
        handling: 'Thin gauge, mixed insulation types.',
        icon: Cpu,
    },
    {
        category: 'Mixed Low-Grade Cable',
        examples: 'General demolition scrap.',
        handling: 'Contaminated or unknown composition.',
        icon: Package,
    },
];

const WireCableScrapCategories = () => {
    return (
            ...
            <div className="ewaste-categories__container max-w-screen-2xl mx-0 md:mx-auto px-0 flex flex-col gap-4 md:gap-[24px]">
                <div className="ewaste-categories__header text-center flex flex-col items-center gap-2 md:gap-4 scroll-reveal">
                    ...
                    <p className="ewaste-categories__subtitle dark:text-gray-400 text-gray-600 max-w-3xl">
                        We handle all types of wire and cable scrap, ensuring maximum metal recovery and responsible processing.
                    </p>
                </div>
                ...
                <div className="ewaste-categories__grid-wrapper scroll-reveal max-w-[1152px] mx-0 md:mx-auto w-full">
                    <div className="ewaste-categories__grid-outer overflow-hidden rounded-3xl border border-[#47622A]/10 dark:border-[#799851]/20 bg-gradient-to-br from-[#47622A]/5 to-[#799851]/5 dark:from-[#799851]/10 dark:to-[#47622A]/10 backdrop-blur-md bg-white/90 dark:bg-[#111]/90 shadow-sm">
                        ...
                        <div className="ewaste-categories__grid-header grid grid-cols-[1.2fr_2fr_2fr] md:grid-cols-[1fr_2fr_2fr] bg-[#47622A] dark:bg-[#1a1a1a] border-b dark:border-white/10 border-transparent text-white dark:text-gray-200">
                            <h6 className="ewaste-categories__th p-2 md:p-[12px] text-[16px] md:text-base font-bold uppercase tracking-wider text-center border-r md:border-r-0 border-white/20">Grade</h6>
                            ...
                            <h6 className="ewaste-categories__th p-2 md:p-[12px] text-[16px] md:text-base font-bold uppercase tracking-wider text-center">Description</h6>
                        </div>
...
export default WireCableScrapCategories;
