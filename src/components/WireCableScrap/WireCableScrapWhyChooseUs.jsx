...
import { CloudRain, Droplets, ShieldAlert, TrendingDown } from 'lucide-react';

const whyPoints = [
    {
        icon: CloudRain,
        title: 'Toxic Air Pollution',
        description: 'Burning PVC insulation releases dioxins, furans, and hydrochloric acid—potent carcinogens and respiratory irritants that devastate local air quality.',
    },
    {
        icon: Droplets,
        title: 'Soil & Water Contamination',
        description: 'Acidic soot and residues from burning poison the land and local water supplies, creating long-term environmental hazards.',
    },
    {
        icon: ShieldAlert,
        title: 'Worker Exploitation & Danger',
        description: 'Manual stripping with blades is a slow and dangerous process that yields poor recovery rates and puts workers at high physical risk.',
    },
    {
        icon: TrendingDown,
        title: 'Value Loss & Degradation',
        description: 'Burning damages the core metal, reducing its grade and price. Mixed plastic residue contaminates the output, leading to significant financial losses.',
    },
];

const WireCableScrapWhyChooseUs = () => {
    return (
            ...
            <div className="ewaste-why__container max-w-screen-2xl mx-0 md:mx-auto px-0 flex flex-col gap-4 md:gap-[24px]">
                <div className="ewaste-why__header text-center flex flex-col items-center justify-start gap-2 md:gap-4 scroll-reveal">
                    ...
                    <h2 className="ewaste-why__heading !text-transparent !bg-clip-text bg-gradient-to-r from-[#47622A] to-[#799851]">
                        The High Cost of Primitive Recycling
                    </h2>
                    <p className="ewaste-why__subtitle dark:text-gray-400 text-gray-600 max-w-none">
                        Wire scrap is heterogeneous, coming in countless sizes and insulation types.<br />
                        Recovering the metal profitably and responsibly requires sophisticated technology.
                    </p>
                </div>
                ...
                <div className="ewaste-why__cta-wrapper flex justify-center scroll-reveal">
                    <div className="ewaste-why__cta-banner w-full max-w-[1152px] p-4 md:p-[24px] rounded-3xl bg-gradient-to-r from-[#47622A] to-[#799851] dark:!bg-none dark:bg-black text-white relative overflow-hidden">
                        <div className="ewaste-why__cta-text relative z-10 flex flex-col items-center text-center lg:items-start lg:text-left gap-2 md:gap-[16px]">
                            ...
                            <p className="font-semibold text-white/90">We replace fire with precision machinery. Our granulation process is a closed-loop, pollution-free system that delivers superior yields and quality, fully compliant with Environmental Protection Acts.</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default WireCableScrapWhyChooseUs;
