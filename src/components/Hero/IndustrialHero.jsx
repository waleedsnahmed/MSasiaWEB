...
function IndustrialHero() {
    ...
    return (
        ...
        */
        <section className="industrial-hero min-h-screen flex flex-col items-center justify-center gap-6 !pt-[80px] lg:pt-[82px] lg:pb-0 relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white dark:from-gray-900 dark:via-gray-950 dark:to-black">
            ...
            {/* Container spanning full width without side margins */}
            <div className="industrial-hero-container items-center justify-center w-full gap-12 h-[500px]">
