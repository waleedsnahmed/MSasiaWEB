...
import { Search, FileSignature, Truck, Recycle, Activity, ShieldCheck } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'Comprehensive sampling, RCRA characterization, and hazardous classification analysis.',
    icon: Search,
  ...
  {
    number: 2,
    title: 'Regulatory Profiling',
    description: 'Developing detailed waste profiles acceptable to permitted TSDFs and recycling partners.',
    icon: FileSignature,
  ...
  },
  {
    ...
    description: 'Deploying explosion-proof vacuum trucks, pressurized tankers, and sealed roll-offs.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Treatment Pathway Design',
    description: 'Optimizing destinations for energy recovery, metals extraction, or secure disposal.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'Coordinating work permits, safety briefings, and managing turnaround waste logistics.',
    icon: Activity,
  ...
  {
    number: 6,
    title: 'Decommissioning & Closure',
    description: 'Chemical cleaning, systematic dismantling, site remediation, and final closure reporting.',
    icon: ShieldCheck,
...
const RefineryProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="refinery-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="refinery-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Integrated with your operating procedures, from waste identification to closure documentation.
                    </motion.p>
                </div>
...
export default RefineryProcess;
