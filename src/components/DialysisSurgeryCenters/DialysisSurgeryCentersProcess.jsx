...
const phases = [
  {
    ...
    description: 'Detailed evaluation of your waste streams, patient volume, and treatment schedules to design flexible, non-disruptive pickup times.',
    icon: ClipboardCheck,
  ...
  },
  {
    ...
    description: 'Provision of appropriate, clearly labeled containment in all treatment and storage areas to ensure safety and prevent cross-contamination.',
    icon: Package,
  ...
  },
  {
    ...
    description: 'Reliable, routine pickups prevent the build-up of regulated waste and help centers adhere to maximum storage time limits.',
    icon: Clock,
  ...
  },
  {
    ...
    description: 'Waste is transported via licensed, DOT-compliant vehicles with trained personnel and secure chain-of-custody manifests.',
    icon: MapPin,
  ...
  },
  {
    ...
    description: 'Waste is rendered non-infectious through approved methods (autoclaving, incineration, or neutralization) before final, compliant disposal.',
    icon: Cog,
  ...
  },
  {
    ...
    description: 'Complete audit-ready documentation and tracking is provided for every step, ensuring full regulatory traceability.',
    icon: FileCheck,
...
const DialysisSurgeryCentersProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="dialysis-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="dialysis-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        We operate on a foundation of safety, security, and strict regulatory adherence.
                    </motion.p>
                </div>
...
export default DialysisSurgeryCentersProcess;
