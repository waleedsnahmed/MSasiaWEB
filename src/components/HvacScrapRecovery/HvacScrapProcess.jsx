...
import { Target, ShieldCheck, Wrench, Recycle, Truck, FileCheck } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'On-Site Survey & Quotation',
    description: 'Our certified technicians survey the site to properly inventory HVAC assets, assess critical refrigerant capacities, and evaluate complex high-altitude access logistics.',
    icon: Target,
  ...
  {
    number: 2,
    title: 'Safe Refrigerant Recovery',
    description: 'The critical first step. Using authorized EPA-certified extraction machinery, we safely recover all greenhouse refrigerants into dedicated cylinders without risking atmospheric venting.',
    icon: ShieldCheck,
  ...
  {
    number: 3,
    title: 'Dismantling & Segregation',
    description: 'Degassed units are cleanly disassembled. Evaporator cores are extracted, compressors are purged of internal oils, and core PCBs are removed directly for the E-waste channel.',
    icon: Wrench,
  ...
  {
    number: 4,
    title: 'Material Upgrading',
    description: 'Advanced processing purifies the metals. Copper tubing is cleaned of residual solders achieving #1 output grade, while aluminium fins are compressed entirely for secondary smelting.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'Pure copper and steel channels are routed to dedicated smelters, while recovered hazardous refrigerants are legally transferred entirely to licensed destruction or reclamation facilities.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'We permanently close the loop by providing detailed Refrigerant Recovery Logs alongside material weights, generating a comprehensive Certificate of HVAC Recycling for ESG reporting.',
    icon: FileCheck,
        ...
        <section id="roadmap-process" className="ewaste-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="ewaste-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        We safely manage the complete decommissioning pipeline—from extracting regulated refrigerant gases down to generating maximum purity metal yields.
                    </motion.p>
                </div>
...
export default HvacScrapProcess;
