...
import { Globe, Flame, HeartPulse, Gavel } from 'lucide-react';

const whyPoints = [
    {
        icon: Globe,
        title: 'Environmental Crime',
        description: 'Under informal methods, refrigerants are simply vented into the atmosphere, contributing massively to ozone depletion and global warming.',
    },
    {
        icon: Flame,
        title: 'Toxic Air Pollution',
        description: 'Unauthorized burning of complex copper coils to strictly strip insulation illegally releases dangerous dioxins and other immediate carcinogens.',
    },
    {
        icon: HeartPulse,
        title: 'Severe Health Hazards',
        description: 'Direct atmospheric exposure to unrecovered refrigerants and released synthetic oils can instantly cause asphyxiation, frostbite, or severe organ damage.',
    },
    {
        icon: Gavel,
        title: 'Legal Liability',
        description: 'Building owners and contractors outsourcing to unlicensed "kabadi" handlers remain ultimately liable for severe regulatory violations and value destruction.',
    },
];

const HvacScrapWhyChooseUs = () => {
    return (
        <section className="ewaste-why bg-white dark:bg-black !py-0">
            <div className="ewaste-why__container max-w-screen-2xl mx-0 md:mx-auto px-0 flex flex-col gap-4 md:gap-[24px]">
                <div className="ewaste-why__header text-center flex flex-col items-center justify-start gap-2 md:gap-4 scroll-reveal">
                    <h6 className="ewaste-why__label text-[#47622A] dark:text-[#799851] uppercase">Risks of Informal Dismantling</h6>
                    <h2 className="ewaste-why__heading !text-transparent !bg-clip-text bg-gradient-to-r from-[#47622A] to-[#799851]">
                        The Complex Composition of HVAC Scrap
                    </h2>
                    <p className="ewaste-why__subtitle dark:text-gray-400 text-gray-600 max-w-none">
                        An HVAC unit is a layered asset containing high-value, hazardous, and regulated materials. Improper disposal is environmentally damaging and absolutely illegal.
                    </p>
                </div>
                ...
                <div className="ewaste-why__cta-wrapper flex justify-center scroll-reveal">
                    <div className="ewaste-why__cta-banner w-full max-w-[1152px] p-4 md:p-[24px] rounded-3xl bg-gradient-to-r from-[#47622A] to-[#799851] dark:!bg-none dark:bg-black text-white relative overflow-hidden">
                        <div className="ewaste-why__cta-text relative z-10 flex flex-col items-center text-center lg:items-start lg:text-left gap-2 md:gap-[16px]">
                            <h4 className="ewaste-why__cta-strong block text-white font-bold">Our Certified Solution</h4>
                            <p className="font-semibold text-white/90">We replace inherently risky, informal dismantling with a systematic, technology-aided process that prioritizes comprehensive environmental safety and material integrity.</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default HvacScrapWhyChooseUs;
