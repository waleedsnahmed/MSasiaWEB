...
import { Search, PenTool, LayoutTemplate, Calendar, Truck, FileCheck } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'Detailed review of the specific project scope, expected waste types, and the required regulatory compliance framework.',
    icon: Search,
  ...
  },
  {
    ...
    description: 'Developing highly customized waste management plans tailored to perfectly match each phase of the project lifecycle.',
    icon: PenTool,
  ...
  },
  {
    ...
    description: 'Deploying the appropriate containers and clear signage to ensure safe, compliant waste handling directly on site.',
    icon: LayoutTemplate,
  ...
  },
  {
    ...
    description: 'Highly flexible collection schedules that dynamically adapt as the project evolves and waste volumes fluctuate.',
    icon: Calendar,
  ...
  },
  {
    ...
    description: 'All materials are transported securely via licensed vehicles operated by highly trained, certified personnel.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Providing full traceability, audit-ready records, and comprehensive regulatory support for complete peace of mind.',
    icon: FileCheck,
...
const EngineeringConsultingProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="engineering-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="engineering-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Customized service from project kick-off to final documentation.
                    </motion.p>
                </div>
...
export default EngineeringConsultingProcess;
