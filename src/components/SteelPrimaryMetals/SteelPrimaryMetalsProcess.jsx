...
import { Search, Map, Truck, Recycle, ShieldCheck, FileText } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'Our team of metallurgists and operations specialists conducts a comprehensive process and waste stream assessment of your facility. We map every scrap generation point across raw material handling, production, and finishing, assessing contamination levels such as dirt, oil, and non-metallic inclusions.',
    icon: Search,
  ...
  },
  {
    ...
    description: 'We develop a customized management plan featuring targeted segregation protocols. We supply and maintain appropriately labeled, dedicated containers—from roll-offs for shredder feed to sealed chip wagons—to strictly enforce segregation at the source and maximize material value.',
    icon: Map,
  ...
  },
  {
    ...
    description: 'We operate on a predictable schedule aligned with your production cycles, offering flexibility for emergency pick-ups to prevent overflow. Our certified operators manage the physical interface with precision, utilizing licensed vehicles and performing all loading under formal Job Safety Analysis protocols.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Materials are transported to state-of-the-art yards equipped with hydraulic shears, mobile balers, and massive shredders. Meticulous sorting utilizing magnetic separation and eddy currents ensures that ferrous and non-ferrous streams are kept pristine and prepared to exact mill specifications.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'Hazardous process residues and contaminated materials are rigorously managed. Streams carrying regulatory implications, such as lead-painted steel or oily turnings, are definitively classified and routed for specialized stabilization, reclamation, or environmentally secure, licensed disposal.',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: 'You receive a comprehensive package including certified weight tickets initiating a digital chain-of-custody, a transparent settlement summary based on published commodity indices, certificates of recycling, and environmental impact reports quantifying energy savings and avoided CO2 emissions.',
    icon: FileText,
...
const SteelPrimaryMetalsProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="steel-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="steel-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Our solutions integrate seamlessly with your production schedule and maintenance turnarounds.
                    </motion.p>
                </div>
...
export default SteelPrimaryMetalsProcess;
