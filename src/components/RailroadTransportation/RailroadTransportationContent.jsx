...
import './RailroadTransportationContent.css';

// Direct import for Hero as it's the first thing seen
import RailroadTransportationHero from './RailroadTransportationHero';

// Lazy load the rest of the page components
const RailroadTransportationWhyChooseUs = lazy(() => import('./RailroadTransportationWhyChooseUs'));
const RailroadTransportationProcess = lazy(() => import('./RailroadTransportationProcess'));
const RailroadTransportationCategories = lazy(() => import('./RailroadTransportationCategories'));
const RailroadTransportationIndustries = lazy(() => import('./RailroadTransportationIndustries'));
const RailroadTransportationBenefits = lazy(() => import('./RailroadTransportationBenefits'));
const RailroadTransportationContactCTA = lazy(() => import('./RailroadTransportationContactCTA'));

const RailroadTransportationContent = () => {
