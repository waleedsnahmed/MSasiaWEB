...
import { Search, Map, Truck, Recycle, TreePine, FileCheck } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'Detailed evaluation of rail yards, depots, and maintenance cycles to align with operational realities.',
    icon: Search,
  ...
  },
  {
    ...
    description: 'Proper containment and clear segregation systems established for hazardous and industrial materials at the source.',
    icon: Map,
  ...
  },
  {
    ...
    description: 'Scheduled and on-demand collection utilizing licensed vehicles and personnel familiar with rail site security.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Large-scale recovery of tracks, components, and heavy metals prioritizing recycling and resource value.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'Handling and compliant disposal of contaminated soil, ballast materials, and hazardous maintenance waste.',
    icon: TreePine,
  ...
  },
  {
    ...
    description: 'Full chain-of-custody documentation, manifest tracking, and audit-ready records for regulatory inspections.',
    icon: FileCheck,
...
const RailroadTransportationProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="rail-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="rail-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Programs custom-built to match operational scale and safety requirements.
                    </motion.p>
                </div>
...
export default RailroadTransportationProcess;
