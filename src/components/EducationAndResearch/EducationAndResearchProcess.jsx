...
import { ClipboardCheck, LayoutTemplate, Truck, MapPin, Recycle, Award } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'We begin with a detailed review of waste generation across all departments and facilities. We perform safe handling and secure preparation of hazardous materials from teaching and research laboratories to ensure full compliance and identify specific logistical needs.',
    icon: ClipboardCheck,
  ...
  },
  {
    ...
    description: 'We manage source segregation by providing and strategically placing appropriate color-coded containers and clear signage across all campus facilities. This ensures organized segregation of diverse waste streams right at the point of generation.',
    icon: LayoutTemplate,
  ...
  },
  {
    ...
    description: 'We implement customized collection with reliable pickups perfectly aligned with your specific academic calendar. This includes daily collection of classroom and administrative waste, ensuring clean and hygienic handling for common areas and hostels.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'All materials are moved via secure transportation using licensed vehicles and strictly trained personnel. A detailed manifest system is maintained at all times to ensure full traceability and accountability from your campus to the final processing facility.',
    icon: MapPin,
  ...
  },
  {
    ...
    description: 'We direct waste to appropriate destinations—recycling, treatment, or secure disposal based on waste type. Biohazardous waste goes to licensed treatment facilities, while chemical waste is processed for compliant disposal via neutralization or stabilization.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'We provide audit-ready documentation and compliance records, ensuring strict adherence to environmental and hazardous waste regulations. We also offer detailed sustainability reporting to support your green campus initiatives and diversion programs.',
    icon: Award,
...
const EducationAndResearchProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="education-research-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="education-research-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        End-to-End Safety & Compliance Flow
                    </motion.h2>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Our end-to-end process is built on a foundation of safety and regulatory adherence, custom-designed for educational ecosystems.
                    </motion.p>
                </div>
...
export default EducationAndResearchProcess;
