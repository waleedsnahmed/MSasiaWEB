...
import { ClipboardList, Trash2, Truck, Settings, PackageOpen } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Scrap Assessment & Planning',
    description: 'Every project begins with a detailed on-site evaluation of aluminium grades, quantity, contamination levels, and logistics requirements to design a customized collection plan.',
    icon: ClipboardList,
  ...
  },
  {
    ...
    description: 'We collect scrap directly from your facility, ensuring rigorous segregation from other metals and removal of non-metal contaminants to maintain material purity.',
    icon: Trash2,
  ...
  },
  {
    ...
    description: 'Utilizing dedicated containers and specialized hydraulic loading equipment, we transport the scrap to our processing facility scheduled to minimize operational disruption.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Processing & Material Preparation',
    description: 'Scrap undergoes further sorting by alloy, removal of coatings, and shredding of oversized pieces to prepare the aluminium for the melting process.',
    icon: Settings,
  ...
  },
  {
    ...
    description: 'Processed aluminium is sent to authorized units for melting and refining, returning to the circular economy as raw material for new industrial products.',
    icon: PackageOpen,
        ...
        <section id="roadmap-process" className="ewaste-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="ewaste-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        From on-site assessment to authorized material recovery, our structured process ensures maximum purity and financial returns.
                    </motion.p>
                </div>
...
export default AluminiumScrapProcess;
