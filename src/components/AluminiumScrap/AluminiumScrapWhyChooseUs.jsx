...
const whyPoints = [
    {
        ...
        description: 'Recycling aluminium requires approximately 95% less energy than primary production, significantly reducing industrial power consumption.',
    },
    {
        icon: Globe,
        title: 'Carbon Emission Reduction',
        description: 'Choosing recycling over primary smelting cuts down on greenhouse gas emissions and environmental degradation associated with bauxite mining.',
    },
    {
        icon: Leaf,
        title: 'Resource Conservation',
        description: 'By reusing secondary aluminium, we drastically reduce the dependency on raw material extraction and help preserve natural ecosystems.',
    },
    {
        icon: Recycle,
        title: 'Circular Economy Contribution',
        description: 'Recovered aluminium is perpetually reusable in new products across automotive, construction, and packaging industries, supporting a true circular loop.',
    },
];

const AluminiumScrapWhyChooseUs = () => {
    return (
        <section className="ewaste-why bg-white dark:bg-black !py-0">
            <div className="ewaste-why__container max-w-screen-2xl mx-0 md:mx-auto px-0 flex flex-col gap-4 md:gap-[24px]">
                <div className="ewaste-why__header text-center flex flex-col items-center justify-start gap-2 md:gap-4 scroll-reveal">
                    <h6 className="ewaste-why__label text-[#47622A] dark:text-[#799851] uppercase">Why It Matters</h6>
                    <h2 className="ewaste-why__heading !text-transparent !bg-clip-text bg-gradient-to-r from-[#47622A] to-[#799851]">
                        Unlocking the Value of Industrial Aluminium
                    </h2>
                    <p className="ewaste-why__subtitle dark:text-gray-400 text-gray-600 max-w-none">
                        Aluminium stands as one of the most environmentally and economically valuable metals. Our process is designed for industries that demand reliability and transparency.
                    </p>
                </div>
                ...
                <div className="ewaste-why__cta-wrapper flex justify-center scroll-reveal">
                    <div className="ewaste-why__cta-banner w-full max-w-[1152px] p-4 md:p-[24px] rounded-3xl bg-gradient-to-r from-[#47622A] to-[#799851] dark:!bg-none dark:bg-black text-white relative overflow-hidden">
                        <div className="ewaste-why__cta-text relative z-10 flex flex-col items-center text-center lg:items-start lg:text-left gap-2 md:gap-[16px]">
                            <h4 className="ewaste-why__cta-strong block text-white font-bold">Partner with MS Asia Enterprises</h4>
                            <p className="font-semibold text-white/90">We turn aluminium waste into reusable value through structured processes, skilled manpower, and responsible recycling methods.</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default AluminiumScrapWhyChooseUs;
