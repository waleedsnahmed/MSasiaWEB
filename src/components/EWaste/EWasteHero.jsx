            ...
            <div className="max-w-screen-2xl mx-auto px-0 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center lg:h-[440px] animate-fadeIn">
                    ...
                    <div className="flex flex-col items-start text-left h-full justify-center gap-y-7 lg:gap-y-8">
                        ...
                        <h1 className="ewaste-hero__heading leading-tight lg:whitespace-nowrap !text-transparent !bg-clip-text bg-gradient-to-r from-[#47622A] to-[#799851]">
                            Advanced E-Waste Recycling
                        </h1>

                        {/* Concise Description */}
                        <div className="ewaste-hero__content flex flex-col gap-y-3">
                            <h5 className="ewaste-hero__description m-0 text-gray-700 dark:text-gray-300 font-normal">
                            ...
                            <h5 className="ewaste-hero__description-secondary m-0 text-gray-700 dark:text-gray-300 normal-case font-normal">
