...
import './ITScrapContent.css';

// Direct import for Hero as it's the first thing seen
import ITScrapHero from './ITScrapHero';

// Lazy load the rest of the page components
const ITScrapWhyChooseUs = lazy(() => import('./ITScrapWhyChooseUs'));
const ITScrapProcess = lazy(() => import('./ITScrapProcess'));
const ITScrapCategories = lazy(() => import('./ITScrapCategories'));
const ITScrapIndustries = lazy(() => import('./ITScrapIndustries'));
const ITScrapBenefits = lazy(() => import('./ITScrapBenefits'));
const ITScrapContactCTA = lazy(() => import('./ITScrapContactCTA'));

const ITScrapContent = () => {
    // E-Waste specific state/effects mapped to ITScrap
    useEffect(() => {
        const handleScroll = () => {
