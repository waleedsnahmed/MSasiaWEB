...
import { ClipboardCheck, Truck, MapPin, ShieldAlert, Cpu, Recycle, FileCheck2 } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Planning & Asset Audit',
    description: 'Our ITAD specialists conduct a detailed audit (remote or on-site) to catalog all assets—servers, storage arrays, networking gear. We identify data-bearing devices and develop a customized project plan.',
    icon: ClipboardCheck,
  },
  {
    number: 2,
    title: 'Secure On-Site Collection',
    description: 'Our uniformed, background-verified crew arrives with secure packing materials. Each asset is scanned, logged into tracking, and options like on-site wiping or tamper-evident staging are applied.',
    icon: ShieldAlert,
  },
  {
    number: 3,
    title: 'GPS-Tracked Transportation',
    description: 'Assets are transported in our dedicated, GPS-monitored vehicles directly to our CPCB-authorized and physically secure ITAD facility. No intermediate stops or unauthorized handling occurs.',
    icon: MapPin,
  },
  {
    number: 4,
    title: 'Certified Data Destruction',
    description: 'In our access-controlled destruction bay, all data storage devices undergo irreversible destruction via NIST 800-88 compliant software or physical shredding down to confetti-sized particles.',
    icon: Cpu,
  },
  {
    number: 5,
    title: 'Systematic Dismantling',
    description: 'Skilled technicians manually disassemble equipment to maximize purity of output streams. Items are separated into printed circuit boards, high-grade metals, plastics, and power supplies.',
    icon: Truck,
  },
  {
    number: 6,
    title: 'Material Recovery & Recycling',
    description: 'Recovered materials are sent to our partner smelters and refiners. Hazardous components are sent to authorized treatment facilities, adhering strictly to a zero-landfill policy.',
    icon: Recycle,
  },
  {
    number: 7,
    title: 'Compliance Closure',
    description: 'You receive a final package including a Certificate of Data Destruction, Certificate of Recycling (EPR compliant), Chain-of-Custody Documentation, and a detailed impact report.',
    icon: FileCheck2,
  }
];
...
const ITScrapProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="itscrap-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="itscrap-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Security at Every Step: Built on the pillars of Security, Compliance, and Transparency.
                    </motion.p>
                </div>
