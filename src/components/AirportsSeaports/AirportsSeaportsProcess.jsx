...
import { Map, Layers, Clock, ShieldCheck, Cog, FileCheck } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'Comprehensive mapping of terminals, docks, hangars, cargo zones, and operational workflows to identify regulatory constraints.',
    icon: Map,
  ...
  {
    number: 2,
    title: 'Segregation Setup',
    description: 'Deploying clearly labeled, high-capacity containers for municipal, hazardous, and regulated international streams.',
    icon: Layers,
  ...
  },
  {
    ...
    description: 'Flexible, routine, and on-demand pickups strategically aligned with 24/7 traffic patterns to prevent operational bottlenecks.',
    icon: Clock,
  ...
  },
  {
    ...
    description: 'All waste is transported securely across restricted areas using authorized vehicles operated by trained, security-cleared personnel.',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: 'Specialized processing including incineration for biosecurity waste, hazardous neutralization, and comprehensive recycling.',
    icon: Cog,
  ...
  },
  {
    ...
    description: 'Providing audit-ready documentation, waste manifests, and treatment certificates ensuring complete regulatory transparency.',
    icon: FileCheck,
...
const AirportsSeaportsProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="airports-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="airports-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        A customized waste management plan aligned with workflows and compliance needs.
                    </motion.p>
                </div>
...
export default AirportsSeaportsProcess;
