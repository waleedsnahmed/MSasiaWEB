...
import './AirportsSeaportsContent.css';

// Direct import for Hero as it's the first thing seen
import AirportsSeaportsHero from './AirportsSeaportsHero';

// Lazy load the rest of the page components
const AirportsSeaportsWhyChooseUs = lazy(() => import('./AirportsSeaportsWhyChooseUs'));
const AirportsSeaportsProcess = lazy(() => import('./AirportsSeaportsProcess'));
const AirportsSeaportsCategories = lazy(() => import('./AirportsSeaportsCategories'));
const AirportsSeaportsIndustries = lazy(() => import('./AirportsSeaportsIndustries'));
const AirportsSeaportsBenefits = lazy(() => import('./AirportsSeaportsBenefits'));
const AirportsSeaportsContactCTA = lazy(() => import('./AirportsSeaportsContactCTA'));

const AirportsSeaportsContent = () => {
