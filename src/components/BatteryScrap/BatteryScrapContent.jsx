...
import BatteryScrapHero from './BatteryScrapHero';

// Lazy load the rest of the page components
const BatteryScrapWhyChooseUs = lazy(() => import('./BatteryScrapWhyChooseUs'));
const BatteryScrapProcess = lazy(() => import('./BatteryScrapProcess'));
const BatteryScrapCategories = lazy(() => import('./BatteryScrapCategories'));
const BatteryScrapIndustries = lazy(() => import('./BatteryScrapIndustries'));
const BatteryScrapBenefits = lazy(() => import('./BatteryScrapBenefits'));
const BatteryScrapContactCTA = lazy(() => import('./BatteryScrapContactCTA'));

const BatteryScrapContent = () => {
