...
import { ClipboardCheck, ShieldCheck, Truck, Flame, FileBadge } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Risk Assessment & Customized Container Solution',
    description: 'We begin by understanding the specific sharps generation profile of each client. We supply CPCB-compliant, UN-approved containers with puncture-resistant walls and secure closure mechanisms tailored for large hospitals down to individual home users.',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'Secure On-Site Protocols & Staff Training',
    description: 'Safety starts at the point of generation. We implement strict protocols including point-of-use placement, no recapping rules, and fill limit compliance, along with comprehensive staff training programs to prevent needlestick injuries.',
    icon: ShieldCheck,
  ...
  {
    number: 3,
    title: 'Secure Collection & Transportation',
    description: 'Our logistics are designed for the unique risks of sharps transport. We offer scheduled pickups using dedicated vehicles with locked, segregated compartments, secondary containment, and full chain-of-custody documentation via barcoded containers.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Advanced Treatment & Destruction',
    description: 'We guarantee complete and irreversible destruction. Standard sharps undergo autoclaving and sterilization followed by high-shear shredding. For chemotherapy or high-risk pharmaceutical sharps, we utilize high-temperature incineration.',
    icon: Flame,
  ...
  {
    number: 5,
    title: 'Certification & Compliance Closure',
    description: 'We provide undeniable proof of responsible disposal with a Certificate of Destruction detailing treatment specifics. A digital audit trail links your container\'s barcode to its entire journey, providing regulatory reporting data for the Pollution Control Board.',
    icon: FileBadge,
...
const SharpsDisposalProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="sharps-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="sharps-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        A Step-by-Step Framework for India: Ensuring safety and compliance at every step.
                    </motion.p>
                </div>
...
export default SharpsDisposalProcess;
