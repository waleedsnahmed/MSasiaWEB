...
const phases = [
  {
    ...
    description: 'We conduct a comprehensive Facility Assessment of R&D, manufacturing, and quality operations. We review generation points and ensure strict compliance with occupational health and safety standards from the outset.',
    icon: ClipboardCheck,
  ...
  },
  {
    ...
    description: 'We develop advanced Segregation Planning with compliant container deployment and labeling, utilizing compatibility-based segregation for safe handling of sensitive, chemical, and biohazardous materials.',
    icon: LayoutTemplate,
  ...
  },
  {
    ...
    description: 'We implement Scheduled Collection aligned with strict production cycles and research protocols. All materials are handled exclusively by highly trained personnel to prevent any risk of cross-contamination.',
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Secure handling guarantees the safe movement of sensitive, chemical, and biohazardous materials. We utilize fully licensed vehicles to ensure strict compliance during transportation to authorized treatment facilities.',
    icon: MapPin,
  ...
  {
    number: 5,
    title: 'Treatment & Destruction',
    description: 'We guarantee the secure handling of expired drugs and environmentally responsible destruction. Biohazardous waste receives licensed treatment through sterilization or incineration, ensuring complete regulatory compliance.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'We provide full traceability and accountability with Audit-ready records for regulatory inspections. This rigorous documentation supports essential quality and compliance documentation requirements for your operations.',
    icon: Award,
...
const PharmaceuticalBiotechnologyProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="pharma-biotech-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="pharma-biotech-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        Compliance, Control, and Destruction Flow
                    </motion.h2>
                    <motion.p 
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Our process ensures waste is managed safely, compliantly, and with full documentation from the lab bench to final destruction.
                    </motion.p>
                </div>
...
export default PharmaceuticalBiotechnologyProcess;
