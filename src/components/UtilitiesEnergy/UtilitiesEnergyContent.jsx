...
import './UtilitiesEnergyContent.css';

// Direct import for Hero as it's the first thing seen
import UtilitiesEnergyHero from './UtilitiesEnergyHero';

// Lazy load the rest of the page components
const UtilitiesEnergyWhyChooseUs = lazy(() => import('./UtilitiesEnergyWhyChooseUs'));
const UtilitiesEnergyProcess = lazy(() => import('./UtilitiesEnergyProcess'));
const UtilitiesEnergyCategories = lazy(() => import('./UtilitiesEnergyCategories'));
const UtilitiesEnergyIndustries = lazy(() => import('./UtilitiesEnergyIndustries'));
const UtilitiesEnergyBenefits = lazy(() => import('./UtilitiesEnergyBenefits'));
const UtilitiesEnergyContactCTA = lazy(() => import('./UtilitiesEnergyContactCTA'));

const UtilitiesEnergyContent = () => {
