...
import { ShieldCheck, TestTube, Construction, Truck, Recycle, FileText } from 'lucide-react';
...
const phases = [
  {
    ...
    description: 'We develop a comprehensive regulatory matrix mapping every waste stream to its governing regulations to establish a clear compliance pathway.',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: 'Using certified labs, we develop Sampling and Analysis Plans (SAPs) to definitively classify suspect materials before transport.',
    icon: TestTube,
  ...
  },
  {
    ...
    description: 'We design on-site workflows and safety plans incorporating utility Clearance & Tagging procedures to prevent cross-contamination.',
    icon: Construction,
  ...
  },
  {
    ...
    description: 'Our fleet of compliant vehicles and HazMat-trained drivers ensure materials move safely and legally from generation points.',
    icon: Truck,
  ...
  {
    number: 5,
    title: 'Processing & Decontamination',
    description: 'We operate permitted facilities capable of cleaning equipment to TSCA standards and recovering clean metals from cabling.',
    icon: Recycle,
  ...
  },
  {
    ...
    description: 'Clients receive an unbroken digital chain of custody, compliance reporting, and transparent settlement backed by commodity indices.',
    icon: FileText,
...
const UtilitiesEnergyProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="utilities-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="utilities-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
                <div className="text-center flex flex-col items-center gap-2 md:gap-4">
                    ...
                    >
                        A systematic, phase-gated methodology integrating compliance and value recovery at every step.
                    </motion.p>
                </div>
...
export default UtilitiesEnergyProcess;
