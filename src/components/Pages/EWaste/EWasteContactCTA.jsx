    ...
    return (
        <section className="ewaste-contact bg-white dark:bg-black">
            <div className="ewaste-contact__container max-w-screen-2xl mx-auto px-0">
                <div className="ewaste-contact__banner flex flex-col gap-6 bg-gradient-to-b from-[#799851] to-[#47622A] p-[12px] md:p-[24px] min-h-[348px] justify-center text-center text-white relative overflow-hidden scroll-reveal w-[100vw] left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
