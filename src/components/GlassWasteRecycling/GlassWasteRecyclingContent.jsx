...
import './GlassWasteRecyclingContent.css';

// Direct import for Hero as it's the first thing seen
import GlassWasteRecyclingHero from './GlassWasteRecyclingHero';

// Lazy load the rest of the page components
const GlassWasteRecyclingWhyChooseUs = lazy(() => import('./GlassWasteRecyclingWhyChooseUs'));
const GlassWasteRecyclingProcess = lazy(() => import('./GlassWasteRecyclingProcess'));
const GlassWasteRecyclingCategories = lazy(() => import('./GlassWasteRecyclingCategories'));
const GlassWasteRecyclingIndustries = lazy(() => import('./GlassWasteRecyclingIndustries'));
const GlassWasteRecyclingBenefits = lazy(() => import('./GlassWasteRecyclingBenefits'));
const GlassWasteRecyclingContactCTA = lazy(() => import('./GlassWasteRecyclingContactCTA'));

const GlassWasteRecyclingContent = () => {
    // Glass Waste Recycling specific state/effects
    useEffect(() => {
        const handleScroll = () => {
