...
const GlassWasteRecyclingHero = () => {
    return (
        <section className="GlassWasteRecycling-hero flex flex-col before:content-[''] after:content-[''] !py-0">
            <div className="max-w-screen-2xl mx-0 md:mx-auto px-0 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12 items-center lg:h-[440px] animate-fadeIn">
                    ...
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left h-full justify-center gap-2 md:gap-4 lg:gap-8">
                        {/* Pill Badge */}
                        <div className="GlassWasteRecycling-hero__badge inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gray-50 dark:bg-[#111111] border border-gray-100 dark:border-gray-800 shadow-sm">
                            <div className="GlassWasteRecycling-hero__badge-dot w-1.5 h-1.5 rounded-full bg-[#47622A] animate-pulse"></div>
                            <h6 className="GlassWasteRecycling-hero__badge-text text-[#47622A] dark:text-[#799851] uppercase">
                                Electronics Recycling
                            </h6>
                        </div>

                        {/* Large Two-Tone Heading */}
                        <h1 className="GlassWasteRecycling-hero__heading leading-tight !text-transparent !bg-clip-text bg-gradient-to-r from-[#47622A] to-[#799851]">
                            Advanced Glass Waste Recycling Recycling
                        </h1>

                        {/* Concise Description */}
                        <div className="GlassWasteRecycling-hero__content flex flex-col gap-y-3">
                            <h5 className="GlassWasteRecycling-hero__description m-0 text-gray-700 dark:text-gray-300 font-normal text-[18px]">
                                From consumer electronics to enterprise servers, we process all forms of Glass Waste Recycling. Our advanced separation technologies recover high-purity metals and plastics, returning them to the circular economy.
                            </h5>
                            <p className="GlassWasteRecycling-hero__description-secondary m-0 text-gray-700 dark:text-gray-300 normal-case font-normal">
...
export default GlassWasteRecyclingHero;
