...
import './GlassWasteContent.css';

// Direct import for Hero as it's the first thing seen
import GlassWasteHero from './GlassWasteHero';

// Lazy load the rest of the page components
const GlassWasteWhyChooseUs = lazy(() => import('./GlassWasteWhyChooseUs'));
const GlassWasteProcess = lazy(() => import('./GlassWasteProcess'));
const GlassWasteCategories = lazy(() => import('./GlassWasteCategories'));
const GlassWasteIndustries = lazy(() => import('./GlassWasteIndustries'));
const GlassWasteBenefits = lazy(() => import('./GlassWasteBenefits'));
const GlassWasteContactCTA = lazy(() => import('./GlassWasteContactCTA'));

const GlassWasteContent = () => {
    // Glass Waste specific state/effects
    useEffect(() => {
        const handleScroll = () => {
    ...
    return (
        <div className="max-w-screen-2xl w-full px-3 lg:px-3 mx-0 lg:mx-auto flex flex-col gap-4 md:gap-[48px]">
            ...
            <Suspense fallback={<div className="flex justify-center items-center h-48"><p>Loading Contact...</p></div>}>
                <GlassWasteContactCTA />
            </Suspense>
        </div>
    );
};

export default GlassWasteContent;
