...
const GlassWasteRecyclingProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="GlassWasteRecycling-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="GlassWasteRecycling-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
...
export default GlassWasteRecyclingProcess;
