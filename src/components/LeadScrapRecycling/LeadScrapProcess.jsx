...
import { ClipboardCheck, MapPin, Truck, Cog, Recycle } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Scrap Assessment and Safety Planning',
    description: 'Every lead recycling project starts with a detailed assessment. We evaluate the type of lead material, storage conditions, and required safety equipment to tailor a specific handling plan.',
    icon: ClipboardCheck,
  ...
  {
    number: 2,
    title: 'Controlled On-Site Collection',
    description: 'Lead scrap is collected using rigorous safety protocols, including sealed containers and protective equipment for personnel, ensuring no fugitive dust or spillage.',
    icon: MapPin,
  ...
  },
  {
    ...
    description: 'Transportation must adhere to hazardous materials regulations. We use leak-proof containers and authorized transport routes to minimize exposure and environmental risk.',
    icon: Truck,
  ...
  {
    number: 4,
    title: 'Processing and Material Preparation',
    description: 'At authorized facilities, lead scrap is sorted, classified, and non-lead materials are removed under fully contained conditions to prevent lead dust creation.',
    icon: Cog,
  ...
  {
    number: 5,
    title: 'Recycling and High-Purity Lead Recovery',
    description: 'Processed lead is sent to approved secondary smelters where it is melted and purified into high-purity refined lead ingots, reducing mining dependency.',
    icon: Recycle,
...
const LeadScrapProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="LeadScrap-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="LeadScrap-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
...
export default LeadScrapProcess;
