...
import './LeadScrapContent.css';

// Direct import for Hero as it's the first thing seen
import LeadScrapHero from './LeadScrapHero';

// Lazy load the rest of the page components
const LeadScrapWhyChooseUs = lazy(() => import('./LeadScrapWhyChooseUs'));
const LeadScrapProcess = lazy(() => import('./LeadScrapProcess'));
const LeadScrapCategories = lazy(() => import('./LeadScrapCategories'));
const LeadScrapIndustries = lazy(() => import('./LeadScrapIndustries'));
const LeadScrapBenefits = lazy(() => import('./LeadScrapBenefits'));
const LeadScrapContactCTA = lazy(() => import('./LeadScrapContactCTA'));

const LeadScrapContent = () => {
    // Lead Scrap specific state/effects
    useEffect(() => {
        const handleScroll = () => {
...
export default LeadScrapContent;
