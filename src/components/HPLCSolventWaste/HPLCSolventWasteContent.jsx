...
import './HPLCSolventWasteContent.css';

// Direct import for Hero as it's the first thing seen
import HPLCSolventWasteHero from './HPLCSolventWasteHero';

// Lazy load the rest of the page components
const HPLCSolventWasteWhyChooseUs = lazy(() => import('./HPLCSolventWasteWhyChooseUs'));
const HPLCSolventWasteProcess = lazy(() => import('./HPLCSolventWasteProcess'));
const HPLCSolventWasteCategories = lazy(() => import('./HPLCSolventWasteCategories'));
const HPLCSolventWasteIndustries = lazy(() => import('./HPLCSolventWasteIndustries'));
const HPLCSolventWasteBenefits = lazy(() => import('./HPLCSolventWasteBenefits'));
const HPLCSolventWasteContactCTA = lazy(() => import('./HPLCSolventWasteContactCTA'));

const HPLCSolventWasteContent = () => {
