...
import { Magnet, ScanLine, Scissors, PackageCheck, Recycle } from 'lucide-react';
import { motion, useScroll, useInView } from 'framer-motion';

const phases = [
  {
    number: 1,
    title: 'Magnetic Base Sorting',
    description: 'All incoming material passes under powerful magnets. Magnetic material (likely 400 series or carbon steel) is isolated to severely protect the higher-value non-magnetic 300 series (304, 316).',
    icon: Magnet,
  ...
  {
    number: 2,
    title: 'XRF Grade Analysis',
    description: 'Technicians use handheld X-Ray Fluorescence Spectrometers for instant, non-destructive chemical analysis, definitively distinguishing 304 vs. 316, 304 vs. 201, and 430 vs. 409.',
    icon: ScanLine,
  ...
  {
    number: 3,
    title: 'Processing and Preparation',
    description: 'Heavy plates and beams are sheared to a uniform size (e.g., 1m x 1m). Thin gauge scrap—sheet, collars, trim—is densely baled to drastically improve melting efficiency and reduce oxidation.',
    icon: Scissors,
  ...
  {
    number: 4,
    title: 'Packaging and Certification',
    description: 'Each rigorously XRF-sorted grade is packed separately in dedicated containers. For large homogeneous lots, we provide comprehensive certificates indicating the primary confirmed grade.',
    icon: PackageCheck,
  ...
  {
    number: 5,
    title: 'Dispatch to Specialty Consumers',
    description: 'Pure 304 & 316 streams are routed to major mills. 430 & 410 feeds specific ferritic production. 200 Series scrap is securely sent to manufacturers specializing strictly in low-nickel applications.',
    icon: Recycle,
...
const StainlessSteelScrapProcess = () => {
    ...
    return (
        <section id="roadmap-process" className="StainlessSteelScrap-process bg-white dark:bg-black !p-0 flex justify-center overflow-hidden">
            <div className="StainlessSteelScrap-process__container max-w-[1400px] w-full flex flex-col gap-4 md:gap-6">
...
export default StainlessSteelScrapProcess;
